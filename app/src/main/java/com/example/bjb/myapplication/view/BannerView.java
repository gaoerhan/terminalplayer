...
public class BannerView extends RelativeLayout implements ViewerCallback {
    ...
    private void initView(List<Integer> pics, int interval) {
        mInterval = interval;
...
//                Log.e("player","当前条目"+mViewPager.getCurrentItem());
    ...
    private class BannerPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            imageLoader.displayImage("drawable://" + mPics.get(position%mItemCount),imageView,options);
