 ...
 */
public class VideoPlayer extends NoDialogVideoView implements
    ...
    public VideoPlayer(final Context context, Video video, ViewGroup group) {
        super(context);
        ...
        jumpLink = video.getJumpLink();
        final String packageName = APPUtils.getPackageNameByAppName(context,jumpLink);
        if (panel) {
    ...
    public VideoPlayer(Context context, Video ele, ViewGroup group, int isonepage) {
